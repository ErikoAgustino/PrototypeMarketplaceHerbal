    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{route('obatBelanjaList')}}" class="nav-link">
                        <i class="nav-icon fa fa-soccer-ball-o"></i>
                        <p>Beli Obat</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{route('statusBelanjaList')}}" class="nav-link">
                        <i class="nav-icon fa fa-soccer-ball-o"></i>
                        <p>Status Belanja</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{route('obatList')}}" class="nav-link">
                        <i class="nav-icon fa fa-soccer-ball-o"></i>
                        <p>Jual Obat</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{route('statusPenjualanList')}}" class="nav-link">
                        <i class="nav-icon fa fa-soccer-ball-o"></i>
